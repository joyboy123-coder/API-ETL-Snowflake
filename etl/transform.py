...
def transform_data(data):
    try:
        ...
        logging.info("⏱️ Cleaning RUNNING_TIME_MIN")
        ...
        logging.info("🗑️ Dropping Unnecessary Columns")
        df.drop(columns=['SOURCE', 'CREATIVE_TYPE', 'ROTTEN_TOMATOES_RATING'], inplace=True)

        logging.info("🎞️ Cleaning MAJOR_GENRE")
        ...
        logging.info("🗳️ Cleaning IMDB_VOTES")
